...
export const Navigation: React.FC<NavigationProps> = ({
  ...
  return (
    <nav className="nav" id="nav">
      <div className="nav__logo-and-buying-categories-container">
        <Link to="/" className="logo">
          <img className="logo__img" src={IMAGES.logo} alt="Logo" />
        </Link>

        <div className="nav__buying-categories">
          <NavigationLink to="/" name="Home" extraClass="nav__link--left" />
          <NavigationLink
            to="/phones"
            name="Phones"
      ...
      <div className="nav__search-and-saving-categories">
          ...
          <div className="nav__search-section">
            ...
            <button
              ...
              className={classNames(
                'nav__search-picture-and-delete',
                newQuery
        ...
        <div className="nav__saving-categories">
          ...
          >
            {favLength > 0 && (
              <div className="nav__link-count">{favLength}</div>
            )}
          </NavigationLink>
          <NavigationLink
            to="/cart"
          ...
          >
            {cartLength > 0 && (
              <div className="nav__link-count">{cartLength}</div>
            )}
          </NavigationLink>
        </div>
      </div>
