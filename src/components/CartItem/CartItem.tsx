...
export const CartItem: React.FC<CartItemProps> = ({
  ...
  const { cart, deleteItemFromCart, changeQuantity } =
  ...
  return (
    <div className="cart-item">
      ...
      <div className="cart-item__data">
        ...
        <div className="cart-item__data-name">{product.name}</div>
      </div>
      ...
      <div className="cart-item__quantity">
        ...
        <div className="cart-item__quantity-number">{quantity}</div>
      ...
      <div className="cart-item__price">{`$${product.priceDiscount}`}</div>
    </div>
  );
};
