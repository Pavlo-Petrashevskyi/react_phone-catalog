...
export const CartPage: React.FC<CartPageProps> = ({ setCartLength }) => {
  ...
  return (
    <div className="cart-page">
      ...
      {cart.length > 0 ? (
        <>
          ...
          <div className="cart-page__info">
            ...
            <div className="cart-page__info-container">
              <div className="cart-page__info-total">
        ...
        <div className="cart-page__empty-cart">Your cart is empty</div>
      )}
    </div>
  );
};
