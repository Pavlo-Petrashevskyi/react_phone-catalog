...
export const ProductDetailsPage: React.FC<ProductDetailsPageProps> = ({
  ...
  useEffect(() => {
    ...
    getSuggestedProducts().then(setShuffledProducts);

    setIsSelectedToCard(!!findItemInCart(productId));

    setIsSelectedToFav(!!findItemInFav(productId));
  }, [productId]);
        ...
        <div className="product-details">
          {productDetails ? (
            <>
              ...
              <div className="product-details__image-and-selection-sections">
                <div className="product-details__image-section">
                  <div className="product-details__images">
                    {productDetails.images.map((image: string) => {
                      return (
                        imageExists(
                          `https://mate-academy.github.io/react_phone-catalog/_new/${image}`,
                        ) && (
                          <div
                            key={image}
                ...
                <div className="product-details__selection-section">
                  ...
                  <div className="product-details__info">
                    <div className="product-details__info-price-and-buttons">
                      {state ? (
                        <div className="product-details__info-price">
                          <div className="product-details__info-price-new">
                            {`$${productDetails?.priceDiscount}`}
                          </div>

                          <div className="product-details__info-price-old">
                    ...
                    <div className="product-details__info-params">
                      {techSpecs.slice(0, 4).map(({ title, value }) => (
                        <div
                          ...
                          key={value}
                        >
                          <div className="product-details__info-param-title">
                            {title}
                          </div>

                          <div className="product-details__info-param-value">
                            {value}
                          </div>
                        </div>
                      ))}
              ...
              <div className="product-details__about-and-techs-specs-sections">
                <div
                  className="product-details__about"
                  data-cy="productDescription"
                >
                  <div className="product-details__about-main-title">About</div>
                  ...
                  <div className="product-details__about-body">
                    {productDetails.description.map(({ title, text }) => (
                      <div
                        ...
                        key={title}
                      >
                        <div className="product-details__about-body-desc-title">
                          {title}
                        </div>

                        <div className="product-details__about-body-desc-texts">
                          {text.map(paragraph => (
                            <div
                              key={paragraph}
                              className={classNames(
                ...
                <div className="product-details__tech-specs">
                  ...
                  <div className="product-details__tech-specs-container">
                    {techSpecs.map(({ title, value }) => (
                      ...
                      >
                        <div className="product-details__tech-specs-body-title">
                          {title}
                        </div>

                        <div className="product-details__tech-specs-body-value">
                          {value}
                        </div>
                      </div>
                    ))}
            ...
            <div className="product-details__not-found-product">
